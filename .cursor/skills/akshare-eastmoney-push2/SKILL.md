---
name: akshare-eastmoney-push2
description: >-
  Acts as an AkShare expert: selecting APIs and running Python for A股/港股/美股/
  期货/基金/宏观/外汇/加密货币 data (pandas.DataFrame workflows). Also documents
  East Money push2 RemoteDisconnected fixes (push2delay host rewrite,
  fetch_paginated_data monkeypatch order). Use for AkShare usage, financial data
  fetching, or eastmoney/push2/clist connection errors.
---
